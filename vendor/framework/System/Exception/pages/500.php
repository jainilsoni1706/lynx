...
<article>
    <aside>
        <p style='color:white;font-size:20px;'>Exception : <span style='font-weight: 900;'>
                <?php echo $message; ?>
            </span> </p> <br>
        <p style='color:white;font-size:20px;'>Exception For : <span style='font-weight: 900;'>
                <?php echo $path; ?>
            </span> </p><br><br><br><svg onclick='render_error.reset().play();' id='render_error'
            xmlns='http://www.w3.org/2000/svg' viewBox='0 0 809 375'>
            <path
